...
def lambda_handler(event, context):
    ...
    try:
        ...
        comment = body.get('comment', 'Cotización rechazada')
        ...
        cursor.execute("SELECT id FROM quotation_statuses WHERE name = 'Rechazada'")
        ...
        return {
            ...
            'body': json.dumps({"message": "Cotización rechazada correctamente"})
        }
